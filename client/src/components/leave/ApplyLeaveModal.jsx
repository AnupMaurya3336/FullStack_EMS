        ...
        max-w-lg animate-fade-in' onClick={(e) => e.stopPropagation()}>
                ...
                <div className='flex items-center justify-between p-6 pb-0'>
                    <div>
                        ...
                        <p className='text-sm text-slate-400 mt-0.5'>Submit your leave
                ...
                <form onSubmit={handleSubmit} className='p-6 space-y-5'>
                    ...
                    text-slate-700 mb-2'>
                        ...
                        <div className='grid grid-cols-2 gap-4'>
                            <div>
                                <span className='block text-xs test-slate-400 mb-1'>Form</span>
                                <input type="date" name="startDate" required
                                    min={minDate} />
                            </div>
                            <div>
                                <span className='block text-xs test-slate-400 mb-1'>To</span>

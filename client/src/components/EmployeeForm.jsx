    ...
    animate-fade-in'>
            ...
            text-slate-700'>
                    ...
                    <div>
                        ...
                        <input type="date" name="joinDate" required defaultValue=
                            {initialData?.joinDate ? new Date
                                (initialData.joinDate).toISOString().split("T")[0] : ""} />
                    </div>
                    <div className='sm:col-span-2'>
                        <label className='block mb-2'>Bio(Optional)</label>
                        <textarea name="bio" required defaultValue=
                            {initialData?.bio} rows={3} className='resize-none'
            ...
            text-slate-700'>
                    <div>
                        ...
                        <select name="department" defaultValue={initialData?.
                            department || ""}>
                    ...
                    <div>
                        ...
                        <input type="number" name="allowances" min="0" step="0.01"
                            required defaultValue={initialData?.allowances || 0} />
                    </div>
                    <div>

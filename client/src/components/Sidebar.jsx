import { CalendarIcon, ChevronRightIcon, DollarSignIcon, FileTextIcon, LayoutGridIcon, LogInIcon, MenuIcon, SettingsIcon, UserIcon, UsersIcon, XIcon, LogOutIcon ,Loader2} from 'lucide-react';
...
const Sidebar = () => {
    ...
    return (
        <>
            ...
            <button onClick={() => setMobileOpen(true)} className='lg:hidden fixed top-4 left-4 z-50 p-2 bg-slate-900 text-white rounded-md bg-white shadow-lg border border-white/10'>
                <MenuIcon size={20} />
            </button>
            ...
            <aside
                ...
                bg-gradient-to-br from-slate-800 via-slate-900 to-slate-900 text-white
            ...
            <aside
                className={`lg:hidden fixed inset-y-0 left-0 w-72
                    ...
                    text-white z-50 flex flex-col transform

...
//       description:"View your profile,check attendance,apply for leave and access payslips",
//       icon:UserIcon
//     }
//   ]
...
//             <h2 className="text-2xl font-medium text-slate-900 tracking-tight mb-3">Welcome Back</h2>
...
const LoginLanding = () => {
  ...
  const portalOptions = [
    ...
    },
    {
      ...
      title: "Employee Portal",
      description:
        "View your profile, check attendance, apply for leave and access payslips",
      icon: UserIcon
    }
  ]
      ...
      <div className="w-full md:w-1/2 flex flex-col items-center justify-center p-6 sm:p-12 lg:p-16 relative overflow-y-auto min-h-screen">
        ...
        <div className="w-full max-w-md animate-fade-in relative z-10">
          ...
          <div className="mt-10 text-center md:text-left text-sm text-slate-400">
            <p>© {new Date().getFullYear()} Groza. All rights reserved.</p>
          </div>
        </div>

...
const Employees = () => {
  ...
  const [selectesDept, setSelectedDept] = useState("")
  ...
  const fetchEmployees = useCallback(async () => {
    ...
    setEmployees(dummyEmployeeData.filter((emp) => (selectesDept ? emp.
      department === selectesDept : emp)))
    setTimeout(() => {
      setLoading(false)
    }, 1000)
  }, [selectesDept])
  ...
  return (
    <div className="animate-fade-in">
      ...
      <div className="flex flex-col sm:flex-row items-start 
        sm:items-center sm:justify-between gap-4 mb-8">
        <div>
      ...
      <div className="flex flex-col sm:flex-row gap-3 mb-6">
        ...
        <select value={selectesDept} onChange={(e) => setSelectedDept(e.target.value)}
          className="max-w-40">
